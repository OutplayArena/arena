...
from outplaylabs_arena_sdk.orchestrator import AgentSpec, GameOrchestrator, OrchestratorConfig
...
def quick_play(
    ...
    Args:
        ...
        arena_url: OutplayLabs Arena API URL
        arena_api_key: OutplayLabs Arena API key for creating experiments
