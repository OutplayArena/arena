...
from outplaylabs_arena_sdk.reasoning import ReasoningEffort, ReasoningModerator
...
class LLMAgent:
    ...
    * **Local (stdio):** when *mcp_url* is not provided, spawns a local MCP
    ...
    back to direct REST calls through :class:`~outplaylabs_arena_sdk.client.ArenaClient`.
    """
    ...
    def __init__(
        ...
        Args:
            ...
            arena_url: Base URL of the OutplayLabs Arena server.
    ...
    async def start_mcp(self) -> None:
        ...
        if self.mcp_url:
            ...
            env = {
                "OUTPLAYLABS_ARENA_BASE_URL": self.arena_url,
                "OUTPLAYLABS_ARENA_KEY": self.token,
