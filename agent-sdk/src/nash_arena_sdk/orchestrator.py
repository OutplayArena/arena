...
class AgentSpec:
    ...
    will automatically create an :class:`~nash_arena_sdk.llm_agent.LLMAgent`;
    ...
    def to_llm_config(self) -> LLMConfig:
        ...
        Returns:
            An :class:`~nash_arena_sdk.llm_agent.LLMConfig` populated with the
...
class OrchestratorConfig:
    ...
    Attributes:
        ...
        agents: Mapping of player identifiers to their :class:`AgentSpec`
            definitions.
        arena_url: Base URL of the Nash Arena HTTP API.
...
class GameOrchestrator:
    ...
    async def setup(self) -> dict:
        ...
        that specify a ``model``, an :class:`~nash_arena_sdk.llm_agent.LLMAgent`
    ...
    async def _process_turn(self, state: dict) -> None:
        ...
        to the arena.  Supports both :class:`~nash_arena_sdk.llm_agent.LLMAgent`
