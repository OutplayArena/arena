...
interface TexasHoldEmConfigFormProps {
  gameSlug: string;
  locked: boolean;
...
export default function TexasHoldEmConfigForm({ gameSlug, locked, sessionStatus, initialValues }: TexasHoldEmConfigFormProps) {
