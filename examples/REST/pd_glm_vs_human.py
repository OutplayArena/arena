"""
Prisoner's Dilemma: GLM-5.1 vs Human Player

This agent joins an existing Prisoner's Dilemma game session using a session key
and plays as GLM-5.1 against a human player.

Usage:
    export SESSION_KEY="nks_..."
    export OPENCODE_GO_API_KEY="..."
    python pd_glm_vs_human.py
"""
...
SESSION_KEY = os.environ.get("SESSION_KEY", "nks_NWJkN2EzMjgtYzFjMi00OTFjLTlkNzQtOWY2NTU2NzM5ZDkwOkI6YzA3OTYyZTM4ODBlNjZlMjdlMDlhN2Y4NzI1N2Y5ZGQ5MDgzZjVhOWU1Y2JiZTQ1MzMwODA5YzVkZGY4MzAyYg")
...
async def play_game():
    ...
    print(f"=== Prisoner's Dilemma: {MODEL} vs Human ===")
    ...
    scenario_name = scenario.get("name", "Classic")
    ...
    result_file = os.path.join(RESULTS_DIR, f"pd_{MODEL}_vs_human_{timestamp}.json")
