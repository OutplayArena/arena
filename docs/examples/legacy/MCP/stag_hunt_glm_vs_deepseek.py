...
To wire a real Claude agent instead, configure MCP with:
  OUTPLAYARENA_KEY=<player_token>  OUTPLAYARENA_BASE_URL=<url>
"""
import asyncio
import os
import sys
...
async def run():
    ...
    agent_a = MCPAgent(player_tokens["A"], OUTPLAYARENA_BASE_URL)
    agent_b = MCPAgent(player_tokens["B"], OUTPLAYARENA_BASE_URL)
