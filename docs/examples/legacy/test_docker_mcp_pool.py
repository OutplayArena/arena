...
OUTPLAYARENA_BASE_URL = f"http://{_backend_ip}:8000/api"
OUTPLAYARENA_API_KEY = "nka_jYhmJ_GINGK48vcoUHKid_jCb1NH4cNXGZZCTsiEbak"
...
async def main():
    ...
    print(f"Arena: {OUTPLAYARENA_BASE_URL}")
    print("=" * 60)
    print()
    ...
    agents = {
        "A": MCPAgent(player_tokens["A"], mcp_url=mcp_url, base_url=OUTPLAYARENA_BASE_URL),
        "B": MCPAgent(player_tokens["B"], mcp_url=None, base_url=OUTPLAYARENA_BASE_URL),  # REST fallback
    }
