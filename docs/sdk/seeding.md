...
The backend now echoes the full effective experiment config (including `seed`) in three response payloads &mdash; `creation_response`, `public_state`, and `get_results` (see [PR #37](https://github.com/OutplayLabs/arena/pull/37)).
