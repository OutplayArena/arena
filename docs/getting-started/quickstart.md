...
2. Start the OutplayArena backend (see [Deployment](../deployment/docker.md))
...
This single call:
1. Creates an experiment on the OutplayArena backend
...
```python
from outplayarena_sdk import ArenaClient, LLMAgent, LLMConfig
