...
How NashArena generates prompts for LLM agents.

## Overview

NashArena uses Jinja2 templates to generate structured prompts for LLM agents. Each game defines its own prompt templates that are rendered with game-specific variables at runtime.
