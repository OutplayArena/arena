...
describe("Chicken Game UI Contract", () => {
  it("LiveView renders without match (empty state)", async () => {
    const mod = await import("@games/community/chicken_game/ui/LiveView.tsx");
  ...
  it("ConfigForm renders with standard props", async () => {
    const mod = await import("@games/community/chicken_game/ui/ConfigForm.tsx");
    const ConfigForm = mod.default;
    renderWithProviders(<ConfigForm gameSlug="chicken_game" locked={false} />);
