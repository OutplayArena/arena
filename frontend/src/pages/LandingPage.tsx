    ...
    <div className="flex-1 flex flex-col">
      ...
      <section className="px-6 py-24 max-w-6xl mx-auto w-full">
        <div className="mb-12 text-center">
          <p className="text-xs font-mono font-medium text-accent uppercase tracking-widest mb-3">Why OutplayArena</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-start">
          ...
          <div className="space-y-5 border-l-2 border-accent/30 pl-6">
            ...
            <p className="text-sm text-ink font-medium leading-relaxed">
              The OutplayArena is our attempt to close it: open, reproducible, and built on the same mathematical foundations that
